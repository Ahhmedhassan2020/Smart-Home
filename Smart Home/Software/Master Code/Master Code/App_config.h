...
#define PASS_SYMPOL (uint8)'*'
#define ASCII_ZERO (uint8)'0'
#define PASS_Flag (uint8)0
...
#define ADMIN_TIMEOUT (uint16)3000 //3 seconds 
#define GUEST_TIMEOUT (uint16)2000 //2 seconds
/****************************   Show menu codes  *****************************************/
