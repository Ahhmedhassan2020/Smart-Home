...
#define LCD_EN_PIN		    (uint8)2
#define LCD_THIRD_PIN		(uint8)3
#define LCD_FOURTH_PIN		(uint8)4
#define LCD_FIFTH_PIN		(uint8)5
#define LCD_SIXTH_PIN		(uint8)6
